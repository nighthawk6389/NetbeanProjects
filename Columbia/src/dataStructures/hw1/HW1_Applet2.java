 ...
 * @author Mavis Beacon
 */
public class HW1_Applet2 extends Applet {
    ...
    public void init(){
        ...
        int numArray [];
        boolean used [];        //DIFFERENT FROM APPLET 1
        int randInt;
        while( (time.getElapsedTime() < STOP_TIME) && (max < 500000) ){
            ...
            System.out.println(max + " " + time.getElapsedTime());
        ...
        yaxis_left.setLabelFont(new Font("Helvetica",Font.PLAIN,14));
